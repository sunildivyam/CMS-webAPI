...
namespace CMS_webAPI.Controllers
{
    public class QuizzesController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetQuizById(int param1)
        {
            int quizId = param1;
            ...
            Quiz quiz = await db.Quizzes.FindAsync(quizId);
            if (quiz == null)
            {
                return NotFound();
            }
        ...
        private Quiz UpdateQuiz(QuizViewModel quizView)
        {
            ...
            db.Entry(quiz).Property(x => x.UpdateCount).IsModified = false;
        ...
        private Question AddQuestion(QuestionViewModel questionView)
        {
            ...
            question.AuthorId = UserService.getUserByUserName(User.Identity.Name).Id;
        ...
        private Question UpdateQuestion(QuestionViewModel questionView)
        {
            ...
            db.Entry(question).Property(x => x.UpdateCount).IsModified = false;
